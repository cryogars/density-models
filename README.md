...
<li>Source code for our paper (https://doi.org/10.1175/AIES-D-25-0021.1).</li>
...
Note: The Python version in the `ml_density_env` evironment will be the default version on your PC. You can manage Python versions using [pyenv](https://github.com/pyenv/pyenv).
...
When you clone this repository, you should already have the data folder, which contains all datasets less than 100 GB used in this work. To access the datasets > 100 GB, download them:
...
<details close> 
  <summary><h2>Estimate Snow Density using our Model</summary>
...
5. U.S. Army CRREL for the funding (projects W913E523C0002 and W913E524C0015).
